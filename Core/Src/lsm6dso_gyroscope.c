...
const uint8_t LSM6DSO_OUTX_L_G_ADDR = 0x22;
const uint8_t LSM6DSO_OUTX_H_G_ADDR = 0x23;
const uint8_t LSM6DSO_OUTY_L_G_ADDR = 0x24;
const uint8_t LSM6DSO_OUTY_H_G_ADDR = 0x25;
const uint8_t LSM6DSO_OUTZ_L_G_ADDR = 0x26;
const uint8_t LSM6DSO_OUTZ_H_G_ADDR = 0x27;
